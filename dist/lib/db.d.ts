...
export declare function Post_Query(select: string, filt: any, plimit: number | undefined, res: any, next: any): Promise<any>;
...
export declare function Insert_Query(sql: string, req: any, res: any, next: any): Promise<any>;
export declare function Update_Query(//pool:any, 
sql: string, req: any, res: any, next: any): Promise<any>;
